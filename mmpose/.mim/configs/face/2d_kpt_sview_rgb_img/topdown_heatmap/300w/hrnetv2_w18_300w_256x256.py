...
model = dict(
    ...
    pretrained='/DATACENTER1/chongyang.xiang/code/landmark/KeyPosS/mmpose_pretrained/hrnetv2_w18_300w_256x256-eea53406_20211019.pth',
    backbone=dict(
        type='HRNet',
        in_channels=3,
        extra=dict(
...
# data_root = 'data/300w'
# data_root = '/home/shouzhou.bx/workspace/face_landmark/face_landmark_data/300w/'
data_root = '/DATACENTER1/chongyang.xiang/data/keypoint/300w'
