...
model = dict(
    ...
    pretrained='/DATACENTER3/chongyang.xiang/code/landmark/KeyPosS/mmpose_pretrained/hrnetv2_w18_aflw_256x256-f2bbc62b_20210125.pth',
    backbone=dict(
        type='HRNet',
        in_channels=3,
        extra=dict(
...
# data_root = 'data/aflw'
data_root = '/DATACENTER4/chongyang.xiang/data/keypoint/aflw'
