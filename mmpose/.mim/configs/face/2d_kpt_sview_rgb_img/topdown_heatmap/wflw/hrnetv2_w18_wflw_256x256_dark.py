...
model = dict(
    ...
    pretrained='/DATACENTER1/chongyang.xiang/code/landmark/KeyPosS/mmpose_pretrained/hrnetv2_w18_wflw_256x256_dark-3f8e0c2c_20210125.pth',
    backbone=dict(
        type='HRNet',
        in_channels=3,
        extra=dict(
...
# data_root = 'data/wflw'
data_root = '/DATACENTER1/chongyang.xiang/data/keypoint/wflw'
