...
from mmpose.core.utils.trilateration import keypoints_from_heatmaps_tril, keypoints_from_heatmaps_tril_topK,\
    keypoints_from_heatmaps_randomsample_lls
...
def keypoints_from_heatmaps(heatmaps,
    ...
    if use_udp:
        ...
        if 1:
            ...
            # preds = keypoints_from_heatmaps_tril(heatmaps, preds, center, scale, sigma=2)

            # gauss_newton-iteration
            # preds = keypoints_from_heatmaps_tril_topK(heatmaps, preds, center, scale, sigma=2, phase=True)
            # random_sample 
            # preds = keypoints_from_heatmaps_randomsample_lls(heatmaps, preds, center, scale, sigma=2, phase=True)
            preds = keypoints_from_heatmaps_randomsample_lls(heatmaps, preds, center, scale, sigma=2, phase=True)

            # sgd 
            # preds = keypoints_from_heatmaps_tril_topK_sgd(heatmaps, preds, center, scale, sigma=2, phase=True)
