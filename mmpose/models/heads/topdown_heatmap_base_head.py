...
class TopdownHeatmapBaseHead(nn.Module):
    ...
    def decode(self, img_metas, output, **kwargs):
        ...
        #     for idx2 in range(preds.shape[1]):
        #         gtt=img_metas[idx]['joints_3d'][idx2][0:2]
        #         predd=preds[idx][idx2]
        #         diff=np.sum(np.abs(gtt-predd))
        #         if diff != 0:
        #             print(f'------idx={idx}, idx2={idx2}, abs-diff={diff:.9f}, gt={gtt}, predd={predd}')
        # pdb.set_trace()
        # #---------------------------
